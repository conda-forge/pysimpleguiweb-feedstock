About pysimpleguiweb-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysimpleguiweb-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8935&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysimpleguiweb-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysimpleguiweb` can be installed with `conda`:
...
```
mamba install pysimpleguiweb
```

It is possible to list all of the versions of `pysimpleguiweb` available on your platform with `conda`:
...
```
mamba search pysimpleguiweb --channel conda-forge
```
...
mamba repoquery search pysimpleguiweb --channel conda-forge

# List packages depending on `pysimpleguiweb`:
mamba repoquery whoneeds pysimpleguiweb --channel conda-forge

# List dependencies of `pysimpleguiweb`:
mamba repoquery depends pysimpleguiweb --channel conda-forge
```
